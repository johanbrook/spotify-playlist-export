module.exports = (function() {
  ...
  var Helpers = {
    ...
    bindDeps: function(depsMap, autoRun) {
      var app = this,
          autoRun = autoRun || true

      Object.keys(depsMap).forEach(function(attr) {
        var func = depsMap[attr],
            htmlAttr = '[data-'+attr+']'

        $(htmlAttr).each(function() {
          var source = $(this).data(attr)
